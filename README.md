...
| Skill | What it does |
| --- | --- |
| [Call Notes](skills/call-notes/) | Turn a call or meeting transcript into a structured Word briefing in the August Group house template. |
| [Daily Summary](skills/daily-summary/) | End-of-day debrief pulling Teams, Outlook calendar, and email |
| [Weekly Summary](skills/weekly-summary/) | Weekly recap of activities grouped by topic with open loops |
...
| [Find Unknowns](skills/find-unknowns/) | Surfaces what you don't know you don't know before you build — a quick interview, mock options, or a blindspot sweep, whichever fits the gap. |
| [Grill](skills/grill/) | Interviews you one question at a time before a build, until the spec is out of your head — then hands back a tight brief to build against. |
